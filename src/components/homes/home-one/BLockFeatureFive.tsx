            ...
            <div className="row">
               <div className="col-xl-8 m-auto">
                  <div className="title-one text-center mb-35 lg-mb-20">
                     ...
                     <h3>We’re here to help <br /> you unlock the full potential of your <span>real-world assets with ORWA<img src="/assets/images/shape/title_shape_07.svg" alt="" className="lazy-img" /></span></h3>
